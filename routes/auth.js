...
import { changePassword, deleteUser, editPasswordUser, getCurrentUser, getUser, signIn, signInWidthFaceBook, signInWidthGoogle, signUp, updateUser, userDetail } from "../controllers/user";
...
routeAuth.patch('/users/:id',updateUser);
